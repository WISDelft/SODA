...
def classify(train_len=10000):
    train_len = 35318
    qfeatures = numpy.load("temp_files/qfeatures_type.pik.npy")
    ...
    labels = numpy.load("temp_files/qlabels_type.pik.npy")
    ...
    for train_index, test_index in kf:
        ...
        clf = LogisticRegression(penalty='l2', tol=0.01, class_weight={1:0.28})
        #clf = svm.SVC(kernel='linear', class_weight={1: 1})
        clf.fit(X_train, y_train)
