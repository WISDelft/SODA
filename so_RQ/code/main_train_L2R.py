...
if __name__ == '__main__':
    ...
    alphas = answerer_rec_train_L2R(test_data, t_set, exp_dict_uid, exp_dict_score, act_dict_uid, act_dict_score)#, int(sys.argv[2]))

    dumpfile(alphas, 'alphas_'+sys.argv[1])