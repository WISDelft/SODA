...
if __name__ == '__main__':
    ...
    exp_dict_uid, exp_dict_score = separate_mat_base(exp_data, augment)
    act_dict_uid, act_dict_score = separate_mat_base(act_data, augment)
    ...
    predicted = answerer_rec_base_stateoftheart(test_data, t_set, exp_dict_uid, exp_dict_score, act_dict_uid, act_dict_score, alpha)
