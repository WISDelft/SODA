...
if __name__ == '__main__':
    ...
    model = loadfile_here('alphas_'+sys.argv[1])#+'_'+str(p))
    
    predicted = answerer_rec_using_trained_model_L2R(test_data, t_set, exp_dict_uid, exp_dict_score, act_dict_uid, act_dict_score, model, alpha)
